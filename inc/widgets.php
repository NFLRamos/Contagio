...
if ( ! function_exists( 'understrap_widgets_init' ) ) {
	...
	function understrap_widgets_init() {
		...
		register_sidebar(array(
			'name' => __( 'Footer 1'),
			'id' =>'footer1',
			'description' => __( 'Colunas do footer'),
			'before_title' => '<p style="font-size: 30px;font-weight: 100;">',
			'after_title' => '</p>',
			'before_widget' => '',
			'after_widget'  => '',
		) );
		...
		register_sidebar(array(
			...
			'id' =>'footer2',
			'description' => __( 'Colunas do footer'),
			'before_title' => '<p style="font-size: 48px;letter-spacing: -1.1px;font-weight: 100;">',
			'after_title' => '</p>',
			'before_widget' => '',
			'after_widget'  => '',
		) );
		...
		register_sidebar(array(
			...
			'id' =>'footer4',
			'description' => __( 'Colunas do footer'),
			'before_title' => '<p style="font-size: 20px;font-weight: 100;">',
			'after_title' => '</p>',
			'before_widget' => '',
			'after_widget'  => '',
		) );
